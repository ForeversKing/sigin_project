...
root = sys.path.append(PROJECT_ROOT)
...
if __name__ == '__main__':
    _outdir = '../data/TEXTVOC/VOC2007'
    _draw = bool(0)
    _dest_label_dir, _dest_img_dir, _dest_set_dir = build_voc_dirs(_outdir)
    _doncateothers = bool(1)
    for dset in ['train']:
        _labeldir = '/home/yulongwu/d/ocr/text-detection-ctpn/data/TEXTVOC/VOC2007/re_data/txt'
        _imagedir = '/home/yulongwu/d/ocr/text-detection-ctpn/data/TEXTVOC/VOC2007/re_data/image'
        ...
        for file in files:
            ...
            with open(file, 'r') as f:
                lines = f.readlines()
            for label_name in ['.jpg', '.png', '.JPG']:
                img_file = os.path.join(_imagedir, stem + label_name)
            ...
            doc, objs = generate_xml(image_name, lines, img_size, class_sets=class_sets, doncateothers=_doncateothers)

            cv2.imwrite(os.path.join(_dest_img_dir, image_name), img)
